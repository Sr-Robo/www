...
export default function Sorting({ products: { total, currentFilters } }) {
    ...
    return /*#__PURE__*/ React.createElement("div", {
        className: "cpk-shop-toolbar flex justify-between items-center mb-5"
    }, /*#__PURE__*/ React.createElement("p", {
        className: "woocommerce-result-count"
    }, total > 0 ? _('Mostrando ${start}–${end} de ${total} resultados', {
        start: start.toString(),
        end: end.toString(),
        total: total.toString()
    }) : _('Nenhum resultado encontrado')), /*#__PURE__*/ React.createElement("form", {
        method: "get",
        action: "/shop",
        className: "woocommerce-ordering flex items-center gap-2"
    }, hiddenFilters.map((f)=>f.operation === 'eq' ? /*#__PURE__*/ React.createElement("input", {
            key: f.key,
            type: "hidden",
            name: f.key,
            value: f.value
        ...
        value: ""
    }, _('Ordenar por Padrão')), /*#__PURE__*/ React.createElement("option", {
        value: "price"
    }, _('Ordenar por Preço')), /*#__PURE__*/ React.createElement("option", {
        value: "name"
    }, _('Ordenar por Nome')))));
}
Sorting.propTypes = {
