...
export default function Filter({
  ...
  shopFilters: { availableAttributes, priceRange },
  ...
  return (
    <FilterDispatch.Provider value={contextValue}>
      <div
        className={`cpk-shop-filter-tool hidden md:block ${
      ...
      >
        ...
        />
        <a
          className="cpk-shop-filter-closer flex md:hidden"
          href="#"
          onClick={(e) => {
            e.preventDefault();
            setIsOpen(!isOpen);
      ...
      <a
        className="cpk-shop-filter-opener flex md:hidden"
        href="#"
        onClick={(e) => {
          e.preventDefault();
          setIsOpen(!isOpen);
